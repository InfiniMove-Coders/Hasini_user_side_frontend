...
const Orders = () => {
	...
	return (
		<>
			...
			<div className="border-l-[2px] border-[#133DF6] md:mt-[0px] mt-[3dvw] md:mb-[0px] mb-[10px]">
				<p className="md:text-[130%] text-[5dvw] w-fit m-auto md:m-0 font-bold text-[#133DF6] md:p-[0px_50px] p-[0px_5dvw]">My Orders</p>

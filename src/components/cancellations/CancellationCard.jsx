...
const CancellationCard = () => {
	return (
		<div>
			<div className="w-[100%] h-[120px] border-[1px] border-[rgba(0,0,0,0.5)] rounded-[8px] p-[5px] flex flex-row items-center justify-between">
				...
				<div className="w-[40%] h-[100%] border-r-[1px] border-[black] flex flex-col items-center justify-start gap-[10px]">
					...
					<div className="w-auto h-auto flex flex-col items-center justify-start gap-[5px]">
						...
						<p className="text-[110%] opacity-[0.6] font-[300]">Cancelled Date: 22/01/2025</p>
					</div>
				</div>
